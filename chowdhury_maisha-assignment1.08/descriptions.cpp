...
npc *monster_description::gen_monster()
{
  ...
  np->name = this->name.c_str();
  np->description = this->description.c_str();
  np->symbol = this->symbol;
  np->color = this->color[0];
  np->speed = this->speed.roll();
  np->health = this->hitpoints.roll();
  np->characteristics = this->abilities;
  np->damage = this->damage;
  np->alive = 1;
  return np;
}
...
object *object_description::gen_object()
{
  ...
  obj->description = this->description.c_str();
  obj->symbol = object_symbol[this->type];
  obj->type = this->type;
  obj->color = this->color;
  obj->damage = this->damage;
  obj->hit = this->hit.roll();
  obj->dodge = this->dodge.roll();
  obj->defense = this->defence.roll();
  obj->weight = this->weight.roll();
  obj->speed = this->speed.roll();
  obj->attribute = this->attribute.roll();
  obj->value = this->value.roll();
  obj->seen = false;
